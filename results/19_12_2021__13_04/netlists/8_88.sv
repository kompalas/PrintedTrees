...
module top ( inp, out );
  ...
  OR2X1 U16 ( .A1(inp[1]), .A2(inp[0]), .Y(n12) );
  NAND2X1 U17 ( .A1(n12), .A2(inp[4]), .Y(n14) );
  NAND2X1 U18 ( .A1(inp[4]), .A2(inp[2]), .Y(n13) );
  NAND2X1 U19 ( .A1(n11), .A2(inp[3]), .Y(n17) );
