...
module top ( inp, out );
  ...
  NOR2X1 U16 ( .A1(n12), .A2(n11), .Y(n16) );
  NAND2X1 U17 ( .A1(inp[2]), .A2(inp[1]), .Y(n14) );
  INVX1 U18 ( .A(inp[3]), .Y(n13) );
  NAND2X1 U19 ( .A1(n14), .A2(n13), .Y(n15) );
  NOR2X1 U20 ( .A1(n16), .A2(n15), .Y(n18) );
  NAND2X1 U21 ( .A1(inp[4]), .A2(inp[5]), .Y(n17) );
