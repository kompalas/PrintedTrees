...
module top ( inp, out );
  ...
  NAND2X1 U10 ( .A1(n11), .A2(n8), .Y(n15) );
  NOR2X1 U11 ( .A1(n10), .A2(n9), .Y(n8) );
  INVX1 U12 ( .A(inp[5]), .Y(n9) );
  INVX1 U13 ( .A(inp[6]), .Y(n10) );
  NAND2X1 U14 ( .A1(n13), .A2(n12), .Y(n11) );
  NOR2X1 U15 ( .A1(inp[2]), .A2(inp[1]), .Y(n12) );
  NOR2X1 U16 ( .A1(inp[3]), .A2(inp[4]), .Y(n13) );
